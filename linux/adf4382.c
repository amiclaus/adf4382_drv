...
/* ADF4382 REG0055 Map */
#define ADF4382_COUNTER_RB_LSB_MSK	GENMASK(7, 0)

/* ADF4382 REG0056 Map */
#define ADF4382_COUNTER_RB_MID_MSK	GENMASK(7, 0)

/* ADF4382 REG0057 Map */
#define ADF4382_COUNTER_RB_MSB_MSK	GENMASK(7, 0)

/* ADF4382 REG0058 Map */
#define ADF4382_LUT_BUSY_MSK		BIT(7)
#define ADF4382_SYNC_OK_MSK		BIT(6)
#define ADF4382_DEL_STR_MSK		BIT(5)
#define ADF4382_DEL_ADJ_MSK		BIT(4)
#define ADF4382_REF_OK_MSK		BIT(3)
#define ADF4382_ADC_BUSY_MSK		BIT(2)
#define ADF4382_FSM_BUSY_MSK		BIT(1)
#define ADF4382_LOCKED_MSK		BIT(0)

/* ADF4382 REG0059 Map */
#define ADF4382_VCO1_BIAS_RDBK_MSK	GENMASK(5, 0)

/* ADF4382 REG005A Map*/
#define ADF4382_VCO2_BIAS_RDBK_MSK	GENMASK(5, 0)

/* ADF4382 REG005B Map */
#define ADF4382_CHIP_TEMP_LSB_MSK	GENMASK(7, 0)

/* ADF4382 REG005C Map */
#define ADF4382_CHIP_TEMP_MSB_MSK	BIT(0)

/* ADF4382 REG005D Map */
#define ADF4382_ADC_CODE_MSK		GENMASK(7, 0)

/* ADF4382 REG005E Map */
#define ADF4382_VCO_BAND_LSB_MSK	GENMASK(7, 0)

/* ADF4382 REG005F Map */
#define ADF4382_VCO_CORE_MSK		BIT(1)
#define ADF4382_VCO_BAND_MSB_MSK	BIT(0)

/* ADF4382 REG0060 Map */
#define ADF4382_READBACK_SPARE_MSK	GENMASK(2, 1)
#define ADF4382_ADC_BUSY_1_MSK		BIT(0)

/* ADF4382 REG0061 Map */
#define ADF4382_CUM_PH_ADJ_LSB_MSK	GENMASK(7, 0)

/* ADF4382 REG0062 Map */
#define ADF4382_CUM_PH_ADJ_MID_MSK	GENMASK(7, 0)

/* ADF4382 REG0063 Map */
#define ADF4382_CUM_PH_ADJ_MSB_MSK	BIT(0)

/* ADF4382 REG0064 Map */
#define ADF4382_DEL_CNT_LSB_MSK		GENMASK(7, 0)

/* ADF4382 REG0065 Map */
#define ADF4382_DEL_CNT_MSB_MSK		GENMASK(7, 0)

/* ADF4382 REG0066 Map */
#define ADF4382_FP_VCO_BAND_MSK		GENMASK(7, 0)

/* ADF4382 REG0066 Map */
#define ADF4382_VERSION_MSK		GENMASK(7, 0)
